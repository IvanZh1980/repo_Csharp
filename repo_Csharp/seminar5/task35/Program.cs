...
Console.WriteLine("Случайный массив 123-х чисел в диапазоне [0, 150]: " + string.Join(", ", array));
int count = CountElements(array);
Console.WriteLine("Количество элементов массива, которые лежат в отрезке [10,99]: " + count);
